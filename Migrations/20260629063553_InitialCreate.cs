        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePagePermissions_PageModules_PageModuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPagePermissions_PageModules_PageModuleId",
                        column: x => x.PageModuleId,
                        principalTable: "PageModules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProjectAssignmentHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ReasonTag = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectAssignmentHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectAssignmentHistories_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectAssignmentHistories_Users_ChangedById",
                        column: x => x.ChangedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectAssignmentHistories_Users_NewOwnerId",
                        column: x => x.NewOwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectAssignmentHistories_Users_PreviousOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectModules", x => new { x.ProjectId, x.Name });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresQA = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_Users_QaAssigneeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaskId = table.Column<int>(type: "int", nullable: false),
                    PreviousAssigneeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssignmentHistories_Users_ChangedById",
                        column: x => x.ChangedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssignmentHistories_Users_NewAssigneeId",
                        column: x => x.NewAssigneeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssignmentHistories_Users_PreviousAssigneeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockedByName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskBlockEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskBlockEntries_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskBlockEntries_Users_BlockedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignmentHistories_ChangedById",
                table: "ProjectAssignmentHistories",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignmentHistories_NewOwnerId",
                table: "ProjectAssignmentHistories",
                column: "NewOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignmentHistories_PreviousOwnerId",
                table: "ProjectAssignmentHistories",
                column: "PreviousOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignmentHistories_ProjectId",
                table: "ProjectAssignmentHistories",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePagePermissions_PageModuleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignmentHistories_ChangedById",
                table: "TaskAssignmentHistories",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignmentHistories_NewAssigneeId",
                table: "TaskAssignmentHistories",
                column: "NewAssigneeId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignmentHistories_PreviousAssigneeId",
                table: "TaskAssignmentHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskBlockEntries_BlockedById",
                table: "TaskBlockEntries",
                column: "BlockedById");

            migrationBuilder.CreateIndex(
                name: "IX_TaskBlockEntries_TaskId_BlockedById",
                table: "TaskBlockEntries",
                columns: new[] { "TaskId", "BlockedById" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPagePermissions_PageModuleId",
